...
* @{
*/
#define PRODUCT_KEY "0470ee016e954a73b2ae36f2b81b2bb2"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "5dc96af6b8914ca5b0e76b0f8d070376"
...
#define Motor_Speed_ADDITION                      -3
#define Motor_Speed_MIN                           0
#define Motor_Speed_MAX                           6
...
typedef enum
{
    LED_Color_VALUE0 = 0,//无
    LED_Color_VALUE1 = 1,//橙色
